...
static const char *fonts[] = {"Maple Mono SC NF:size=10"};
static const char dmenufont[] = "Maple Mono SC NF:size=10";
static const char col_gray1[] = "#222222";
static const char col_gray2[] = "#444444";
static const char col_gray3[] = "#bbbbbb";
static const char col_gray4[] = "#eeeeee";
static const char col_cyan[] = "#005577";
static const char col_purple[] = "#4c00b0";
...
static const Rule rules[] = {
    ...
    {"easyeffect",      NULL,           NULL,   1 << 8,         0,               2},
    {"Pavucontrol",     NULL,           NULL,   1 << 8,         0,               2},
    {"thunderbird",     NULL,           NULL,   1 << 7,         0,               2},
    {"Caprine",         NULL,           NULL,   1 << 0,         0,               1},
...
static const Key keys[] = {
    ...
    {ControlMask | ShiftMask,   XK_4,           setlayout,      {.v = &layouts[3]}},
    {ControlMask | ShiftMask,   XK_5,           setlayout,      {.v = &layouts[4]}},
    {ControlMask | ShiftMask,   XK_6,           setlayout,      {.v = &layouts[5]}},
    ...
    {MODKEY | ShiftMask,        XK_Tab,         rotatetags,     {.i = -1}},
    {MODKEY,                    XK_Tab,         rotatetags,     {.i = +1}},
